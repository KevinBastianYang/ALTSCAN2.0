...
//Added by Jim
score_t zExternalBackInternalScore(struct zTrellis *trellis,int ext_state,coor_t ext_pos,int story);
score_t zInternalStartToSpecificScore(struct zTrellis *trellis, int int_state,coor_t int_pos,int int_story,coor_t new_pos);
